...
namespace Strike{
    ...
    struct TextureAtlasData{
        ...
        Vector4 getUVCoords(const SubTexture& subTexture);
    };
    ...
    struct MaterialData{
        ...
        MaterialData(const ResourceHandle& shaderHandle, const ResourceHandle& textureHandle, const Vector4& textureCoords) :
