...
void RenderableComponent::addObject(Object& obj, float minX, float minY, float maxX, float maxY, float resX, float resY, bool doCenter, bool defaultVisibility) {
...
void RenderableComponent::configureBuffers(VertexBuffer& vb, IndexBuffer& ib) {
	vb.bind();
	ib.bind();
