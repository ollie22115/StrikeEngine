...
Object genTriangle(float p0, float p1, float p2, glm::vec3 origin = glm::vec3(0.0f, 0.0f, 0.0f));

Object genCircle(float radius, glm::vec3 origin = glm::vec3(0.0f, 0.0f, 0.0f));